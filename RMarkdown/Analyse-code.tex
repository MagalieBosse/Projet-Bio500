...
\significancestatement{Les réseaux d'étudiants ressemblent à des réseaux
écologiques.}
...
\begin{abstract}
Dans une communauté écologique il est possible d'observer plusieurs
types d'interactions entres les espèces qui sont présentes. En observant
ces interactions on constate certains agencements au sein de ces
communautés. Par exemple, on peut observer certaines espèces qui
interagissent plus entres elles que d'autres. On peut aussi observer que
des espèces interagissent avec un grand nombre d'autres espèces faisant
d'eux un point central des relations écologiques de cette communauté. Le
même genre d'interactions peut être retrouvée en société. En effet, en
comparant les interactions entres les étudiants en biologie de
l'Université de Sherbrooke on constate que les interactions forment eux
aussi des agencements bien particuliers qui se rapproche beaucoup de ce
qu'on peut retrouver en nature.
\end{abstract}
